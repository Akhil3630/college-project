...
const AdminService = () => {
    ...
    const  readDetails = () => {
      ...
      const verifyService = (email,deleted) =>{
        let text;
        if (window.confirm("Add this service?") === true) {
          text = 1;
        ...
        const removeService = (email,deleted) =>{
            ...
            if (window.confirm("Remove this request?") === true) {
              ...
              text = 0;
                 ...
                 text===1 ? axios.post("http://localhost:5000/deleteServices/",{email})
                 .then(res => {
                setuserEmail(res.data)
                 }):console.log()
    ...
    return (
        ...
        <h4 className='text-danger'>SERVICE REQUESTS</h4>
                ...
                <table className='table table-bordered table-hover'>
                    ...
                    {serviceDetails.map((service,key) => {
                        ...
                        <tr key={key} className=' table-danger text-dark'>
                             ...
                             <td><div className='delete-restore-icon' onClick={(e) => verifyService(service.email,service)}><Icon className='text-danger mr-3 sidebar-icons' fontSize={20}  icon="flat-color-icons:accept-database" /></div></td>
                         </tr>
                             )
                    })
