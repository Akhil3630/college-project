                ...
                <table className='table table-bordered table-hover'>
                    ...
                    {serviceDetails.map((service,key) => {
                         return(
                             ...
                             <td><div onClick={(e) => restoreService(service.email)}><Icon icon="ic:baseline-restore-from-trash" /></div></td>
                            <td><div onClick={(e) => removeService(service.email)}><Icon icon="ic:baseline-restore-from-trash" /></div></td>
                         </tr>
                             )
                    })
